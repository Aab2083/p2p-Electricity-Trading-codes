...
// Fetch data
sendHTTPRequest("http://192.168.223.25/mysql_esp/getdata.php", "id=esp32_02", payload);
...
delay(1000);
    ...
    sendHTTPRequest("http://192.168.223.25/mysql_esp/update_record.php", postData, payload);

...
<body>
    ...
    <div class="content">
        <div class="cards">
            ...
            <div class="card">
                ...
                <p class="statusColor"><span class="reading"><span id="esp32_03_stat"></span></p>
                <h4 class="currentColor"><i class="fas fa-tint"></i> current</h4>
                <p class="currentColor"><span class="reading"><span id="esp32_03_curren"></span> A</span></p>
                <h4 class="voltageColor"><i class="fas fa-tint"></i> voltage</h4>
                <p class="voltageColor"><span class="reading"><span id="esp32_03_volt"></span> V</span></p>
                <h4 class="powerColor"><i class="fas fa-tint"></i> power</h4>
                <p class="powerColor"><span class="reading"><span id="esp32_03_pow"></span> W</span></p>
                <!-- *********************************************************************** -->

                <p class="unitreadColor"><span>units transferred : </span><span id="esp32_03_units_trans"></span></p>
            </div>
            <!-- ======================================================================================================= -->
            ...
            <div class="card">
                ...
                <label class="switch">
                    <input type="checkbox" id="esp32_03_Togbuying_mode"
                        onclick="GetTogBtnstatus('esp32_03_Togbuying_mode')">
                    <div class="sliderTS"></div>
                </label>
                <h4 class="LEDColor"><i class="fas fa-lightbulb"></i> Selling mode</h4>
                <label class="switch">
                    <input type="checkbox" id="esp32_03_Togselling_mode"
                        onclick="GetTogBtnstatus('esp32_03_Togselling_mode')">
                    <div class="sliderTS"></div>
                </label>
                <!-- *********************************************************************** -->
            </div>
    ...
    <div class="content">
        <div class="cards">
            <div class="card header" style="border-radius: 15px;">
                <h3 style="font-size: 0.7rem;">LAST TIME RECEIVED DATA FROM ESP32 [ <span id="esp32_03_LTRD"></span> ]</h3>
    ...
    function GetTogBtnstatus(togbtnid) {
        if (togbtnid === "esp32_03_Togbuying_mode" || togbtnid === "esp32_03_Togselling_mode") {
            const togbtnchecked = document.getElementById(togbtnid).checked;
            const status = togbtnchecked ? "ON" : "OFF";
            const modes = togbtnid === "esp32_03_Togbuying_mode" ? "buying_mode" : "selling_mode";

            // Update the status of the toggle button on the server
            UpdateToggleButtonStatus("esp32_03", modes, status);
        }
    }
    document.addEventListener("DOMContentLoaded", function () {
    // Initialize your HTML elements
    document.getElementById("esp32_03_stat").innerHTML = "NN";
    document.getElementById("esp32_03_curren").innerHTML = "NN";
    document.getElementById("esp32_03_volt").innerHTML = "NN";
    document.getElementById("esp32_03_pow").innerHTML = "NN";
    document.getElementById("esp32_03_units_trans").innerHTML = "NN";
    ...
    async function Get_Data(id) {
        try {
            ...
            if (response.ok) {
                ...
                document.getElementById("esp32_03_stat").innerHTML = myObj.status || "NN";
                document.getElementById("esp32_03_curren").innerHTML = myObj.current || "NN";
                document.getElementById("esp32_03_volt").innerHTML = myObj.voltage || "NN";
                document.getElementById("esp32_03_pow").innerHTML = myObj.power || "NN";
                document.getElementById("esp32_03_units_trans").innerHTML = myObj.units_transfered || "NN";
                document.getElementById("esp32_03_LTRD").innerHTML = "Time : " + myObj.ls_time + " | Date : " +

...
<html>
  ...
  <body>
    ...
    <h3 style="color: #0c6980;">RECORDED DATA TABLE</h3>
    ...
    <table class="styled-table" id= "table_id">
      ...
      <tbody id="tbody_table_record">
        <?php
          ...
          $sql = 'SELECT * FROM esp32_01_record ORDER BY date, time';
          foreach ($pdo->query($sql) as $row) {
            ...
            echo '<td class="bdr">'. $row['status'] . '</td>';
            echo '<td class="bdr">'. $row['current'] . '</td>';
            echo '<td class="bdr">'. $row['voltage'] . '</td>';
            echo '<td class="bdr">'. $row['units_transfered'] . '</td>';
            echo '<td class="bdr">'. $row['buying_mode'] . '</td>';
            echo '<td class="bdr">'. $row['selling_mode'] . '</td>';
